...
#     stream = open('./config/det_DB_resnet50.yaml', 'r', encoding='utf-8')
    ...
    parser.add_argument('--config', help='config file path',default='../config/det_DB_mobilev3.yaml')
    parser.add_argument('--model_path', nargs='?', type=str, default='/Users/gwzhome/Desktop/workspace/pytorchOCR/tools/checkpoint/DB_8.pth.tar')
    parser.add_argument('--onnx_path', nargs='?', type=str, default=None)
    parser.add_argument('--trt_path', nargs='?', type=str, default=None)
    parser.add_argument('--img_path', nargs='?', type=str, default='/Users/gwzhome/Desktop/workspace/pytorchOCR/data/test')
