...
class CRNNProcessTrainLmdb(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print(len(self.bg_img))
        # bg_index = np.random.randint(0, len(self.bg_img))
        # print(self.bg_img[bg_index])
...
def GetValDataLoad(config):
    ...
    for i in range(num):
        ...
        batch_size = 1
        num_workers = config['valload']['num_workers']
        config['valload']['test_file'] = os.path.join(root,'rec_val_list.txt')
...
#     config['trainload'] = {}
#     config['valload'] = {}
#     config['trainload']['bg_path']='/Users/gwzhome/Desktop/workspace/pytorchOCR/bg_img/'
#     config['base']['is_gray'] = True
#     config['trainload']['train_file'] =['/Users/gwzhome/Desktop/workspace/pytorchOCR/data/imdb/train_imdb']
#     config['valload']['val_file'] = ['/Users/gwzhome/Desktop/workspace/pytorchOCR/data/imdb/test_imdb']
#     config['trainload']['num_workers'] = 0
#     config['valload']['num_workers'] = 0
#     config['trainload']['batch_size'] = 10
#     config['trainload']['batch_ratio'] = [0.33, 0.33, 0.33]
#     config['transform']={}
#
#     config['transform']['char_type'] = 'En'
#     config['transform']['t_type']='lower'
#     config['trainload']['function'] = 'ptocr.dataloader.RecLoad.CRNNProcess1,GetDataLoad'
...
#     # print(len(train_data_loaders))
#     for batch_idx, (imgs, labels) in enumerate(train_data_loaders[0]):
#         # print(time.time() - t)
#         print(imgs.shape)
#         print(batch_idx)
#         print(labels)
    # val_dataset = GetDataLoad(config, data_type='train')
