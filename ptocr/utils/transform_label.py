...
# config={}
# config['trainload']={}
# config['trainload']['key_file']='/Users/gwzhome/Desktop/workspace/pytorchOCR/data/rec_data/key.txt'
# LabelConvert = strLabelConverter(config)
# print(LabelConvert.encode(val_str,25))
